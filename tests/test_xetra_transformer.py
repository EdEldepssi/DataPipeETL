...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def test_extract_no_files(self):
        ...
        # Notice, in the __init__ method of XetraETL,the MetaProcess class is being called,that way we need to mock it
        ...
        # also in order to run extract() method, you need extract_date_list returned by MetaProcess.return_date_list
